...
function EditarCliente() {
  ...
  return (
    <>
      ...
      <p className="mt-3 text-black font-medium uppercase">A continuación podras modificar los datos de un cliente</p>
      ...
      <div className='bg-white shadow rounded-md md:w-3/4 mx-auto px-5 py-10 mt-10'>
        ...
        <Form method='POST'>
          ...
          <input type="submit" className='mt-5 w-full bg-blue-800 p-3 uppercase font-bold text-white text-lg rounded-md cursor-pointer' value="Actualizar Cliente" />
        </Form>
      </div>
    </>
  )
